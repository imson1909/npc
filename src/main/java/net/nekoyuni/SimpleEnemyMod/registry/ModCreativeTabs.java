...
public class ModCreativeTabs {
   ...
   public static final RegistryObject<CreativeModeTab> SIMPLE_ENEMY_MOD_TAB = CREATIVE_MODE_TABS.register(
      ...
      () -> CreativeModeTab.builder()
         ...
         .icon(() -> new ItemStack((ItemLike)ModItems.RECRUIT_TABLE_ITEM.get()))
         .displayItems((itemDisplayParameters, output) -> {
            output.accept((ItemLike)ModItems.RECRUIT_TABLE_ITEM.get());
            ...
            output.accept((ItemLike)ModItems.US_UNIT_SPAWN_EGG.get());
            output.accept((ItemLike)ModItems.US_SQUAD_LEADER_SPAWN_EGG.get());
            output.accept((ItemLike)ModItems.US_SQUAD_UNIT_SPAWN_EGG.get());
            output.accept((ItemLike)ModItems.RU_UNIT_SPAWN_EGG.get());
            output.accept((ItemLike)ModItems.RU_SQUAD_LEADER_SPAWN_EGG.get());
            output.accept((ItemLike)ModItems.RU_SQUAD_UNIT_SPAWN_EGG.get());
         })
         .build()
   );
