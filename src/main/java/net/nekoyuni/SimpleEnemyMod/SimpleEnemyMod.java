...
import net.nekoyuni.SimpleEnemyMod.registry.ModBlocks;
...
public class SimpleEnemyMod {
   ...
   public static class ClientModEvents {
      ...
      public static void onClientSetup(FMLClientSetupEvent event) {
         EntityRenderers.register((EntityType)ModEntities.USUNIT.get(), USunitRenderer::new);
         EntityRenderers.register((EntityType)ModEntities.RUUNIT.get(), RUunitRenderer::new);
